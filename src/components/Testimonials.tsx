...
export const Testimonials = () => {
  ...
  const testimonials = [
    ...
    {
      quote:
        "Telemetry is that more useful, the more consistent and easy it is to query. Even in a world with the OpenTelemetry semantic conventions, it is common to see implementation oversights and inconsistencies across automatic and manual instrumentations. When the idea of Instrumentation Score came up, I got into almost a drafting frenzy for new rules, delighted to have a way to detect those nasty problems that took too long to troubleshoot and root out.",
    ...
    {
      quote:
        "The #O11y Instrumentation Score is a great way to understand the quality of #OpenTelemetry instrumentation. It offers a way to grok completeness and maturity of #OTel observability instrumentation following semantic conventions and best practices.",
    ...
    {
      quote:
        "Perhaps the only thing worse than no instrumentation is bad instrumentation. Observability Score gives developers and operators a framework for not only evaluating instrumentation quality, but a platform for building fast feedback loops into our telemetry development processes.",
      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-slate-300 max-w-3xl mx-auto">
            Real feedback from teams and organizations using the Instrumentation
            Score to improve their observability
          </p>
        </div>
          ...
          >
            <CardContent className="p-8 md:p-12">
              ...
              <div className="flex items-center justify-center gap-4">
                <div
                  className={`w-12 h-12 rounded-full bg-slate-700 border border-slate-600 flex items-center justify-center`}
                >
                  <currentTestimonial.icon
                    className={`w-6 h-6 ${currentTestimonial.color}`}
                  />
                </div>
